...
/**
 * The CountingOV model
 *
 * @author Jordy Mol
 */
public class CountingOV {
    ...
    /**
     * Instantiates a new CountingOV object
     */
    public CountingOV() {
    }
     ...
     */
    public CountingOV(int cane, int walker, int touchStick, int dog, int manualWheelchair, int electricWheelchair, int scooter, int childParam) {
        this.cane = cane;
        this.walker = walker;
