package nl.hva.amsserver.security;
...
public class JWToken {
    ...
    public static final String JWT_IS_ADMIN_CLAIM = "isAdmin";

    public static final String JWT_EMAIL_CLAIM = "email";

    public static final String JWT_PROFILE_PICTURE_CLAIM = "profilePicture";
    ...
    public JWToken(String callName, Long accountId, String email, String isAdmin, String profilePicture ) {
    ...
    public String encode(String issuer, String passphrase, int expiration) {
        ...
        return Jwts.builder()
                ...
                .claim(JWT_IS_ADMIN_CLAIM, this.isAdmin)
                .claim(JWT_EMAIL_CLAIM, this.email)
                .claim(JWT_PROFILE_PICTURE_CLAIM, this.profilePicture)
                .setIssuer(issuer)
    ...
    public static JWToken decode(String token, String issuer, String passphrase)
        ...
        JWToken jwToken = new JWToken(
                ...
                claims.get(JWT_IS_ADMIN_CLAIM).toString(),
                claims.get(JWT_PROFILE_PICTURE_CLAIM).toString()
        );
        jwToken.setIpAddress((String) claims.get(JWT_IPADDRESS_CLAIM));
        return jwToken;
    }

    public JWToken(String callName, Long accountId, String isAdmin, String email, String profilePicture, String sourceIpAddress) {
        this(callName, accountId, email, isAdmin, profilePicture);
    ...
    public boolean isAdmin() {
        return this.isAdmin.toLowerCase().contains("admin");
    }
